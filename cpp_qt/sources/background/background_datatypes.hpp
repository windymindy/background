...
{
    return state == service_state::none && target_state == target_service_state::none;
}

inline bool serving_state::serving () const
{
    return state == service_state::serving && target_state == target_service_state::none;
}

inline bool serving_state::stopped () const
{
    return state == service_state::stopped && target_state == target_service_state::none;
}

inline bool operator == (const serving_state value_1, const serving_state value_2)
{
    return value_1.state == value_2.state && value_1.target_state == value_2.target_state;
}
