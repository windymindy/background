...
class background_library event_loop_controller_qt : public event_loop_controller
{
    public :
...
class background_library background_event_loop_controller_plugin_qt : public event_loop_controller_plugin
{
    public :
