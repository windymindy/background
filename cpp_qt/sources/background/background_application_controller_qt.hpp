...
class background_library application_controller_qt : public application_controller
{
    public :
...
class background_library background_application_controller_plugin_qt : public application_controller_plugin
{
    public :
